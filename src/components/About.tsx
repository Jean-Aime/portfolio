...
import { Shield, Terminal, Cpu, Globe } from 'lucide-react';
        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          >
            ...
            <p className="text-lg text-slate-400 leading-relaxed">
              I am an Industrial Information Technology graduate with a deep passion for securing digital landscapes. My expertise lies at the intersection of robust network security and modern full-stack development.
            </p>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            >
              ...
              <p className="text-sm text-slate-400">Hardening infrastructures and implementing zero-trust architectures.</p>
            </motion.div>
            <motion.div 
              whileHover={{ y: -10 }}
            ...
            >
              ...
              <h4 className="text-xl font-bold text-white mb-2">Web Dev</h4>
              <p className="text-sm text-slate-400">Creating scalable, secure, and user-centric web applications.</p>
            </motion.div>
          </div>
        </div>
      </div>
